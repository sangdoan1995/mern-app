...
function App() {
	...
	return (
		<Routes>
			<Route path={path.HOME} exact element={<Main />} />
			{user && <Route path={path.APP} element={<Navigate replace to={path.HOME} />} />}
			<Route path={path.SIGNUP} exact element={<Signup />} />
			<Route path={path.LOGIN} exact element={<Login />} />
			<Route path={path.APP} element={<Navigate replace to={path.LOGIN} />} />
